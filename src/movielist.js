...
class MovieList extends Component {
    render() {
        ...
        const movies = [ // Array of objects // movie[2].tittle
            {
                id: 1,
        ...
        // Var to store the movie componenets
        const movieComponents = movies.map((movieItem) => { // movies to one movie  // map runs over the array and it's stored in -movieComponents-
            return <Movie movie={movieItem} />;//<Movie />  class Movie in movie file will add the strucuter of the page , move.map will loop through the array objetct (movie)will show movies
